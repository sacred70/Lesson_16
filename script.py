...
def add_user():
    ...
    try:
        ...
        return 'User with this id has already existed'
...
def add_offer():
    ...
    try:
        ...
        return 'Offer with this id has already existed'
